...
const toolsData = [
  // --- WRITING ---
  { name: 'ChatGPT', tagline: 'The world\'s most popular AI assistant.', category: 'Writing', descriptionShort: 'Versatile AI for writing and coding.', pricing: 'Freemium', rating: 4.8, popularity: 'High', image: 'https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg', link: 'https://chat.openai.com', clicks: 12000 },
  ...
  { name: 'Gemini', tagline: 'Multi-modal analysis.', category: 'Data', descriptionShort: 'Analyze Drive files with Google AI.', pricing: 'Free', rating: 4.7, popularity: 'High', image: 'https://upload.wikimedia.org/wikipedia/commons/4/45/Gemini_logo.svg', link: 'https://gemini.google.com', clicks: 11000 },
  ...
  { name: 'Perplexity', tagline: 'AI search engine.', category: 'Productivity', descriptionShort: 'Cited answers to any question.', pricing: 'Free', rating: 4.9, popularity: 'High', image: 'https://www.perplexity.ai/favicon.ico', link: 'https://perplexity.ai', clicks: 10000 },
