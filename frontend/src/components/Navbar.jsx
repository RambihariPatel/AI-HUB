      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/category/Writing" className="text-sm font-medium text-slate-300 hover:text-white transition-colors">Categories</Link>
            ...
            <button 
              onClick={toggleTheme}
              className="theme-toggle-btn p-2 rounded-lg bg-slate-900/50 hover:bg-slate-800 text-slate-300 hover:text-white transition-all border border-white/5 flex items-center justify-center cursor-pointer"
          ...
          <div className="md:hidden flex items-center space-x-2">
            <button 
              onClick={toggleTheme}
              className="theme-toggle-btn p-2 rounded-lg bg-slate-900/50 text-slate-300 hover:text-white border border-white/5 flex items-center justify-center cursor-pointer"
              title={`Switch to ${theme === 'dark' ? 'Light' : 'Dark'} Mode`}
            >
              {theme === 'dark' ? <Sun className="w-4 h-4 text-amber-400" /> : <Moon className="w-4 h-4 text-indigo-400" />}
            </button>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-slate-950 border-b border-white/5 px-4 pt-2 pb-6 space-y-4">
          <div className="flex flex-col space-y-4 pt-4">
            ...
            <Link to="/category/Writing" onClick={() => setIsMenuOpen(false)} className="text-slate-300">Categories</Link>
